...
/**
 *	\file       htdocs/cashcontrol/template/cashcontrolindex.php
 *	\ingroup    cashcontrol
 *	\brief      Home page of cashcontrol top menu
 */
...
$langs->loadLangs(array("cashcontrol@cashcontrol"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->cashcontrol->read) accessforbidden();
...
llxHeader("",$langs->trans("CashControlArea"));

print load_fiche_titre($langs->trans("CashControlArea"),'','cashcontrol.png@cashcontrol');
...
// Draft MyObject
if (! empty($conf->cashcontrol->enabled) && $user->rights->cashcontrol->read)
{
	$langs->load("orders");
