...
/**
 * \file    modulebuilder/template/core/boxes/cashcontrolwidget1.php
 * \ingroup cashcontrol
 * \brief   Widget provided by CashControl
 *
 ...
 */
class cashcontrolwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "cashcontrolbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "cashcontrol@cashcontrol";
	 ...
	 */
	public $depends = array('cashcontrol');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->cashcontrol->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/cashcontrol/class/cashcontrol.class.php";

		// Populate the head at runtime
		$text = $langs->trans("CashControlBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_cashcontrol@cashcontrol',
