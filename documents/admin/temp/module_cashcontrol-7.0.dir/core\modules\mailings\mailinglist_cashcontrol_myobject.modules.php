...
dol_include_once("/cashcontrol/class/myobject.class.php");


/**
 * mailing_mailinglist_cashcontrol
 */
class mailing_mailinglist_cashcontrol_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_cashcontrol_myobject';
	...
	var $picto='cashcontrol@cashcontrol';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('cashcontrol',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/cashcontrol/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_cashcontrol_myobject.modules.php: mailing ".$num." targets found");
