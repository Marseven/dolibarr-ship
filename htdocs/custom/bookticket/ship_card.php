...
if (is_object($objcanvas) && $objcanvas->displayCanvasExists($action)) {
	...
	if ($action == 'create' && $usercancreate) {
		...
		if ($refalreadyexists)
		{
			...
			// Ref
			print '<tr><td class="titlefieldcreate fieldrequired">'.$langs->trans("Immatriculation").'</td><td colspan="3"><input name="ref" class="maxwidth200" maxlength="128" value="'.dol_escape_htmltag($object->ref).'"></td></tr>';
