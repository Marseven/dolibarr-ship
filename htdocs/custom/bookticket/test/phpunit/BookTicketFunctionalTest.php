...
/**
 * \file    test/phpunit/BookTicketFunctionalTest.php
 * \ingroup bookticket
...
/**
 * Class BookTicketFunctionalTest
 *
 ...
 *
 * @package Testbookticket
 */
class BookTicketFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBookTicket')->click();
		} else {
			// Disable the module
			$this->byHref('modBookTicket')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/bookticket/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('bookticket/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/bookticket/admin/about.php');
		$this->authenticate();
		return $this->assertContains('bookticket/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('bookticketwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBookTicket_BookTicketTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBookTicket_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
