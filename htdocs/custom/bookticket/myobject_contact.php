...
/**
 *  \file       bookticket/myobject_contact.php
 *  \ingroup    bookticket
...
dol_include_once('/bookticket/class/myobject.class.php');
dol_include_once('/bookticket/lib/bookticket_myobject.lib.php');
...
$permission = $user->rights->bookticket->myobject->write;
...
if ($object->id)
{
	...
	$linkback = '<a href="'.dol_buildpath('/bookticket/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
