...
/**
 * \file    bookticket/core/boxes/bookticketwidget1.php
 * \ingroup bookticket
 * \brief   Widget provided by BookTicket
 *
 ...
 */
class bookticketwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "bookticketbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "bookticket@bookticket";
	 ...
	 */
	public $depends = array('bookticket');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->bookticket->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/bookticket/class/bookticket.class.php");

		// Populate the head at runtime
		$text = $langs->trans("BookTicketBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_bookticket@bookticket',
