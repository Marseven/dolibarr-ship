...
class Bticket extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_agence' 		=> array('type'=>'integer:Agence:agence/class/agence.class.php', 'label'=>'Agence', 'picto'=>'classe', 'enabled'=>1, 'visible'=>-2, 'notnull'=> 1, 'position'=>510, 'foreignkey'=>'agence.rowid'),
	...
	public function approve($user = null, $notrigger = 0)
	{
		...
		// Update request
		$sql = "UPDATE ".MAIN_DB_PREFIX."bookticket_bticket SET";
	...
	public function load_stats_by_classe()
	{
		// phpcs:enable
