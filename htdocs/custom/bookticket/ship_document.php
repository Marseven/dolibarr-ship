...
if ($object->id)
{
	...
	$permission = $user->rights->bookticket->ship->write;
	//$permission = 1;
	$permtoedit = $user->rights->bookticket->ship->write;
	//$permtoedit = 1;
	$param = '&id='.$object->id;

	//$relativepathwithnofile='ship/' . dol_sanitizeFileName($object->id).'/';
	$relativepathwithnofile = 'ship/'.dol_sanitizeFileName($object->ref).'/';
