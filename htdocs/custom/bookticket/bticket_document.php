...
/**
 *  \file       htdocs/custom/bookticket/ticket_document.php
 *  \ingroup    bookticket
 *  \brief      Tab for documents linked to Ticket
 */
...
if ($id > 0 || !empty($ref)) $upload_dir = $conf->bookticket->multidir_output[$object->entity ? $object->entity : $conf->entity]."/ticket/".get_exdir(0, 0, 0, 1, $object);
